# ACKNOWNLEDGED PROBLEM

1. Enabled staffs summary in Dashboards page did not reflect the true data.
2. Estimated income did not use real datasource.
3. Some popup dialogs are not fully translated.
